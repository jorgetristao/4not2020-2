...
controller.listar = async (req, res) => {
    try {
        let dados = await Treino.find() //find() sem parametros tras tudo.
        .populate('aluno', 'nome')
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Treino.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Treino.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req,res) => {
    try {
        ...
        let ret = await Treino.findByIdAndDelete(id)
